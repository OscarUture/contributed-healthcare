...
const AddRelative: React.FC<Props> = ({ insured }) => {
  ...
  return (
    <FormControl>
      <Grid>
        <Typography variant="h6">Datos de las mascotas</Typography>
      </Grid>
        ...
        <Grid container={true} wrap="nowrap" alignItems="center">
          <Grid item={true} className="mui-select" sm={3}>
            ...
            >
              ...
              <MenuItem value={RelativeType.SPOUSE}>Perro</MenuItem>
              <MenuItem value={RelativeType.CHILD}>Gato</MenuItem>
            </Select>
          </Grid>
          <Grid item={true} sm={6}>
